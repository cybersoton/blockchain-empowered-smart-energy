...
const modelFolder = __dirname+'../../../blockit-electricity-trading/';
  ...
  it('should have 1 Electricty asset instance with value=10', () => {
    ...
    return businessNetworkConnection.getAssetRegistry(namespace+'.'+AssetType).
        then((reg)=>{
          ...
          // Create the instance
          const asset = factory.newResource(namespace, AssetType, '1', '1', 10);
          asset.setPropertyValue('electricityId', '1');
          asset.setPropertyValue('electricityAmount', 10);
          asset.prosumer = factory.newRelationship(
              'org.blockit.electricity',
              'Prosumer',
              '1');
