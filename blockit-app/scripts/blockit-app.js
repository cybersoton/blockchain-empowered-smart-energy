...
const prosumerId        ={Describe:'Prosumer ID'            ,demand:true,string: true,alias:'p'};
const electricityId     ={Describe:'Electricity ID'         ,demand:true,string: true,alias:'e'};
const listingId         ={Describe:'Listing ID'             ,demand:true,string: true,alias:'l'};
const prosumerIdA       ={Describe:'Prosumer ID for party A',demand:true,string: true,alias:'pa'};
const prosumerIdB       ={Describe:'Prosumer ID for party B',demand:true,string: true,alias:'pb'};
const amount            ={Describe:'Amount of Electricity'  ,demand:true,alias:'a'};
const balance           ={Describe:'Money Balance'          ,demand:true,alias:'bl'};
const bid               ={Describe:'Bid for Electricity'    ,demand:true,alias:'b'};
const reservePrice      ={Describe:'Amount of Electricity'  ,demand:true,alias:'r'};
const name              ={Describe:'Name of Prosumer'       ,demand:false,string: true,alias:'n'};
const description       ={Describe:'Description of Lisitng' ,demand:false,string: true,alias:'d'};
