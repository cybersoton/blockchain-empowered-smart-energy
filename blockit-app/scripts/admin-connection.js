 ...
 * 4. Disconnect 
 * 5. Connect as the Network Admin for Blockit
 * 6. Ping Blockit
 * 7. Disconnect
 */
...
const   cardNameForNetworkAdmin   = "admin@electricity-trading-network";
const   appToBePinged = "electricity-trading-network";
