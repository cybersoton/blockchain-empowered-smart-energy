...
module.exports = {
  ...
  initialize: function(folder, callback) {
    ...
    this.adminConnection = new this
        .AdminConnection({cardStore: cardStore});
    ...
    return this.adminConnection
        .importCard(peerAdminCardName, idCard).then(() => {
          ...
          this.info = definition.metadata
              .packageJson.name + "@" + definition.metadata.packageJson.version;
          ...
          return this
              .adminConnection
              .start(this.businessNetworkDefinition.getName(), this
          ...
          this
              .networkAdminCardName = `admin@${this
          ...
          return this
              .adminConnection
              .importCard(
                  this.networkAdminCardName, networkAdminCardMap.get("admin"));
        }).then(() => {
          this
              .log("Imported Network Admin Card =" + this.networkAdminCardName);

          // 10. Connect the business network
          return this
              .businessNetworkConnection.connect(this.networkAdminCardName);
        }).then(() => {
  ...
  /**
   * @return {idcard} Sets up the Card store and the Network idCard
   * */
